                  ...
                  if (details.opening_hours) {
                    try {
                      ...
                      if (details.opening_hours.periods && details.opening_hours.periods.length > 0) {
                        ...
                        // Find all periods for the current day
                        const todayPeriods = details.opening_hours.periods.filter(period => 
                          period.open && period.open.day === currentDay
                        );
              ...
              {selectedCities.size > 0 && (
                <div style={{ marginTop: '40px' }}>
                  ...
                  <div style={{ backgroundColor: '#f8f8f8', color: '#333', padding: '20px', borderRadius: '10px', marginBottom: '20px' }}>
                    ...
                    <textarea id="preferences" value={preferences} onChange={handlePreferencesChange} placeholder="e.g., family-friendly restaurants, outdoor activities..." autoComplete="off" style={{ width: 'calc(100% - 24px)', minHeight: '100px', padding: '12px', fontSize: '16px', borderRadius: '5px', border: '1px solid #ccc', resize: 'vertical', fontFamily: 'inherit', boxSizing: 'content-box' }} />
